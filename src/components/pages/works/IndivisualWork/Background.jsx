...
export default function RotatedBgComponent({ text }) {
  return (
    <div className="py-10">
      <div className="relative bg-gray-900 text-white overflow-hidden flex justify-center items-center  px-4 text-center">
        ...
        <motion.p
          className="text-lg md:text-xl lg:text-4xl  py-20 font-bold w-full px-4 md:max-w-2xl"
