...
export default function ExpertiseSection() {
  ...
  const sections = [
    { title: "Discovery", content: "A thorough discovery is at the core of every successful digital solution we craft. Understanding who you are building for and why you are building it is more important than the colors or technology you use. If you don’t know these things first, the rest is pointless." },
    { title: "Strategy & Planning", content: "Our strategy and planning ensure that we create a digital solution tailored to your business goals." },
    { title: "Website Solutions", content: "We craft high-quality website solutions that are both functional and visually appealing." },
    { title: "Mobile Apps & Responsive Websites", content: "Our team specializes in creating mobile applications and responsive websites for seamless user experiences." },
  ];
